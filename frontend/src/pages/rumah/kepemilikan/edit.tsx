...
function EditKepemilikan({
  ...
  useEffect(() => {
    if (data) {
      form.setValue("statusHunian", data.statusHunian);
      ...
      setKontrak(data.statusHunian === "KONTRAK");
    }
  }, [data]);
  ...
  return (
    ...
    >
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Edit Kepemilikan</DialogTitle>
        </DialogHeader>
...
export default EditKepemilikan;
